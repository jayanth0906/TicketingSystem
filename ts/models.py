...
class Items(models.Model):
    Item_Id = models.IntegerField(max_length=50, blank=True)
...
class Tickets(models.Model):
    ...
    items = models.ForeignKey(Items, on_delete=models.CASCADE, related_name='items', default='Items_Id', blank=True)
